...
class ActivateIntegrationAction : IntegrationAction<JsonNode, JsonNode> {
    override fun getName(): String {
        return "integration_store_activate"

    }

    override fun getRoutes(): List<Pair<RestRequest.Method, String>> {
        return listOf(
            Pair(RestRequest.Method.PUT, "${IntegrationsPlugin.BASE_INTEGRATIONS_URI}/store/{integration_id}/activate")
        )
    }
